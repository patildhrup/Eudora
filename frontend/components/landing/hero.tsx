...
export function Hero() {
  return (
    <section className="relative overflow-hidden px-4 pb-24 pt-12 sm:px-6 sm:pt-20">
      {/* ── Background orbs ── */}
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium backdrop-blur-sm"
          style={{
        ...
        >
          <Button
            asChild
            size="lg"
            className="group relative h-12 overflow-hidden rounded-full px-8 text-base font-semibold text-white border-0 transition-all duration-300 hover:scale-105"
            style={{
          ...
          <Button
            ...
            variant="ghost"
            size="lg"
            className="h-12 rounded-full border border-border/60 bg-background/60 px-8 text-base backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-primary/5"
          >
